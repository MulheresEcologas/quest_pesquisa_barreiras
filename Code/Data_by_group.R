...
data_cleaned <- data_geral_af %>% 
  ...
  dplyr::rename("COD_ID" = "ID",
                ...
                "Q13_HC"  = "Q18_Você mora na mesma cidade onde está localizada a instituição/empresa a qual você está vinculada (o/e) atualmente?",
                "Q14_HC"  = "Question_19_Se você se mudou para uma nova cidade, estado ou país nos últimos cinco anos, quais foram os fatores motivadores? (Marque todas as opções que se aplicam)",                                              
                "Q15_HC" = "Question_20_Se você já mudou de residência com o objetivo de progredir em sua carreira verifique as categorias que descrevem as consequências de seus movimentos. (Marque todas as opções que se aplicam)",          
                "Q16_HC" = "Question_21_Como/com quem você mora? (Marque todas as opções que se aplicam)",                                                             "Q17_HC" = "Question_22_Quem faz as tarefas domésticas semanais (por exemplo, cozinhar, limpar, lavar roupa) em sua casa? (Marque todas as opções que se aplicam)",
                "Q18_DI" = "Q23_Em qual curso de graduação você se formou?",
                "Q19_DI" = "Question_24_Qual a sua formação na área de ecologia?",
                "Q20_DI" = "Q25_Qual categoria melhor descreve a sua situação atual?",
                "Q21_DI" = "Q26_Há quanto tempo você está na situação acima?",
                "Q22_DI" = "Q28_Qual é a sua renda mensal?",
                "Q23_DI" = "Q30_Qual é a melhor descrição da instituição onde você trabalha atualmente?",
                "Q24_DI" = "Q31_Você possui mais de uma fonte de renda?",
                "Q25_DI" = "Q32_Se respondeu SIM na pergunta anterior, qual outro trabalho você desempenha?",
                ...
                "Q34_AP" = "Q41_Se você fez pós-graduação (ex: especialização, mestrado ou doutorado), a pessoa que te orientou por último foi:",
                ...
                "Q36_AP" = "Question_43_Se você não está mais no meio acadêmico, quais foram os motivos que a/o levaram a sair? (Marque todas as opções que se aplicam)",
                "Q37_AP"  = "Question_44_Se você já realizou trabalho de campo e trouxe alguém com você como assistente de campo, identifique a razão específica para fazê-lo. (Marque todas as opções que se aplicam)",
                "Q38_AGE_AP" = "Q45_Como os fatores listados influenciam a sua produtividade científica? [Idade]",
                "Q38_RACE_AP" = "Q46_Como os fatores listados influenciam a sua produtividade científica? [Raça/Etnia]",
                "Q38_sOCIO_AP" = "Q47_Como os fatores listados influenciam a sua produtividade científica? [Nível Socioeconômico]",
                "Q38_GEO_AP" = "Q48_Como os fatores listados influenciam a sua produtividade científica? [Origem geográfica]",
                "Q38_FAM_AP" = "Q49_Como os fatores listados influenciam a sua produtividade científica? [Responsabilidades familiares]",
                "Q38_TEAC_AP" = "Q50_Como os fatores listados influenciam a sua produtividade científica? [Responsabilidades com ensino]",
                "Q38_ADM_AP" = "Q51_Como os fatores listados influenciam a sua produtividade científica? [Responsabilidades administrativas]",
                "Q38_JOB_AP" = "Q52_Como os fatores listados influenciam a sua produtividade científica? [Falta de segurança no trabalho]",
                "Q38_FUND_AP" = "Q53_Como os fatores listados influenciam a sua produtividade científica? [Falta de financiamento]",
                "Q38_RESOURCE_AP" = "Q54_Como os fatores listados influenciam a sua produtividade científica? [Falta de recursos para fazer meu trabalho (por exemplo, ajuda de escritório/escritório, laboratório, equipamentos, infraestrutura, etc.)]",
                "Q38_GENDER_AP" = "Q55_Como os fatores listados influenciam a sua produtividade científica? [Discriminação de sexo/gênero]",
                "Q39_AP" = "Q57_Qual é a sua MÉDIA/ANO de produção científica (artigos, capítulos de livros, livros), nos últimos 4 anos, ou seja, de 2019 até o momento?",
